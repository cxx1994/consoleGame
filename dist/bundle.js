...
var __ = {
    poolDic: (0, _symbol2.default)('poolDic')
};
...
var Pool = function () {
    ...
    (0, _createClass3.default)(Pool, [{
        ...
        key: 'getItemByClass',
        value: function getItemByClass(name, className, game) {
            var pool = this.getPoolBySign(name);

            return pool.length ? pool.shift() : new className(game);
        }
...
var _pool = __webpack_require__(24);

var _pool2 = _interopRequireDefault(_pool);

var _enemy = __webpack_require__(55);
...
var Game = function () {
    ...
    (0, _createClass3.default)(Game, [{
            ...
            document.onkeydown = function (e) {
                if (e.keyCode === 13) {
                    if (_this.isGameover()) {
                        ...
                        _this.state.pause = !_this.state.pause;
                    }
        ...
        value: function enemyGenerate() {
            if (this.count % 40 === 0) {
                var enemy = _pool2.default.getItemByClass('enemy', _enemy2.default, this);
                enemy.init();
        ...
        value: function render() {
            ...
            console.log('请用键盘的左右键控制玩家左右移动，躲避障碍！');
            console.log('Enter键可以开始、暂停游戏。');
            var s = [].concat((0, _toConsumableArray3.default)(Array(this.camera.height))).map(function () {
                return Array(_this2.camera.width).fill('--');
            });

            this.enemys.forEach(function (enemy) {
                [].concat((0, _toConsumableArray3.default)(enemy.text)).forEach(function (word, index) {
                    s[enemy.y] && (s[enemy.y][enemy.x + index] = word);
                });
            });

            [].concat((0, _toConsumableArray3.default)(this.player.text)).forEach(function (word, index) {
                if (s[_this2.player.y][_this2.player.x + index] === '--') {
                    s[_this2.player.y][_this2.player.x + index] = word;
                } else {
                    _this2.state.end = true;
                }
            });

            s = s.map(function (row) {
                return row.join('');
            });
        ...
        value: function gameLoop() {
            ...
            var gameLoop = function gameLoop() {
                _this3.timer = requestAnimFrame(gameLoop);
                if (_this3.state.pause || _this3.state.end) return false;
                _this3.count++;
                if (_this3.count % 20) {
                    return;
                }
...
var Enemy = function () {
    ...
    (0, _createClass3.default)(Enemy, [{
        key: 'init',
        value: function init() {
            this.text = ['小刀', '枪', '棍', '棒', '陈兴旭的拳头'][(0, _utils.rnd)(0, 5)];
            this.x = (0, _utils.rnd)(0, this._game.camera.width - 2);
            this.y = 0;
            this.speed = 1;
        }
    }, {
        ...
        value: function update() {
            ...
            if (this.y > this._game.camera.height || this.x < 0) {
                this._game.enemys = this._game.enemys.filter(function (item) {
                    return item !== _this;
                });

                _pool2.default.recover('enemy', this);
            }
        }
    }]);
    return Enemy;
